...
export const Mahdaad_EDGELESS_TOOLBAR_WIDGET =
  'mahdaad-edgeless-toolbar-widget';
export class MahdaadEdgelessToolbarWidget extends WidgetComponent<RootBlockModel> {
...
export const mahdaadEdgelessToolbarWidget = WidgetViewExtension(
  'affine:page',
  Mahdaad_EDGELESS_TOOLBAR_WIDGET,
  literal`${unsafeStatic(Mahdaad_EDGELESS_TOOLBAR_WIDGET)}`
);
