...
import { PenTablerIcon } from '@blocksuite/affine-components/icons';
import {
  EditPropsStore,
  ThemeProvider,
...
export class MahdaadEdgelessPenToolButton extends EdgelessToolbarToolMixin(
