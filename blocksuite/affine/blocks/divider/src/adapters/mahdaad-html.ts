...
export const DividerBlockMahdaadHtmlAdapterMatcher: BlockMahdaadHtmlAdapterMatcher =
  {
...
export const DividerBlockMahdaadHtmlAdapterExtension =
  BlockMahdaadHtmlAdapterExtension(DividerBlockMahdaadHtmlAdapterMatcher);
