...
export const listBlockMahdaadHtmlAdapterMatcher: BlockMahdaadHtmlAdapterMatcher =
  {
    ...
    fromBlockSnapshot: {
      enter: (o, context) => {
        ...
        if (o.node.props.type === 'todo') {
          ...
          liChildren.unshift({
            type: 'raw',
            value: o.node.props.checked
              ? checkboxChecked().strings[0]
              : checkboxUnchecked().strings[0],
            //tagName: 'input',
            /*properties: {
            type: 'checkbox',
            checked: o.node.props.checked as boolean,
          ...
          liChildren = [
            {
              ...
              properties: {
                ...
                className: [
                  'todo-item',
                  o.node.props.checked ? 'checked' : 'unchecked',
                ],
              },
              children: liChildren,
            },
...
export const ListBlockMahdaadHtmlAdapterExtension =
  BlockMahdaadHtmlAdapterExtension(listBlockMahdaadHtmlAdapterMatcher);
