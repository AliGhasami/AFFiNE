...
export const Mahdaad_EDGELESS_ZOOM_TOOLBAR_WIDGET =
  'mahdaad-edgeless-zoom-toolbar-widget';

export class MahdaadEdgelessZoomToolbarWidget extends WidgetComponent<
  RootBlockModel,
