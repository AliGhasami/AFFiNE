...
import { MahdaadObjectBlockConfigExtension } from './mahdaad-object-block-config';
import {
...
export const MahdaadObjectBlockSpec: ExtensionType[] = [
  ...
  BlockViewExtension('affine:paragraph', literal`affine-mahdaad-object`),
  ParagraphTextKeymapExtension,
  ParagraphKeymapExtension,
  ParagraphBlockAdapterExtensions,
  MahdaadObjectBlockConfigExtension({
