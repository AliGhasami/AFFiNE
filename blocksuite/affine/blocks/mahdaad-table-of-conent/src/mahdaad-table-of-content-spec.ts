...
import { TableOfContentBlockAdapterExtensions } from './adapters/extension';
export const MahdaadTableOfContentBlockSpec: ExtensionType[] = [
  ...
  BlockViewExtension(
    ...
    literal`affine-mahdaad-table-of-content`
  ),
  SlashMenuConfigExtension(
    'affine:mahdaad-table-of-content',
    mahdaadTableOfContentSlashMenuConfig
  ),
  TableOfContentBlockAdapterExtensions,
].flat();
