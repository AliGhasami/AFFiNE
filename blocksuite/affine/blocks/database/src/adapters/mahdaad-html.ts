...
export const databaseBlockMahdaadHtmlAdapterMatcher: BlockMahdaadHtmlAdapterMatcher =
  {
...
export const DatabaseBlockMahdaadHtmlAdapterExtension =
  BlockMahdaadHtmlAdapterExtension(databaseBlockMahdaadHtmlAdapterMatcher);
